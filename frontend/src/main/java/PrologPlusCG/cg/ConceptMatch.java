...
class ConceptMatch {
	...
	Concept m_ResultOfMatch;
	boolean m_IsConcMatched;
	boolean m_IsMatchedLocally;
	
	ConceptMatch(Concept C1, Concept C2, Concept C3, boolean B1, boolean B2) {
		m_ConcMatched1 = C1;
		m_ConcMatched2 = C2;
		m_ResultOfMatch = C3;
		m_IsConcMatched = B1;
		m_IsMatchedLocally = B2;
	}
	
	void myDestroy() {
		m_ConcMatched1 = null;
		m_ConcMatched2 = null;
		m_ResultOfMatch = null;
	}
}
