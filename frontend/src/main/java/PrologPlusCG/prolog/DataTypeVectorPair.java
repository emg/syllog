...
class DataTypeVectorPair {
	Vector<String> vctSons;
	Vector<String> vectFathers;
	
	DataTypeVectorPair() {
		vctSons = new Vector<String>(5, 3);
		vectFathers = new Vector<String>(5, 3);
	}
	
	DataTypeVectorPair(Vector<String> vSons, Vector<String> vFathers) {
		vctSons = vSons;
		vectFathers = vFathers;
	}
}
