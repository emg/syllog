...
class Constraint {
    Object m_LeftData;
    int m_levelOfLeftData;
    Object m_RightData;
    int m_levelOfRightData;

    Constraint(Object pLeftData, int plevelOfLeftData, Object pRightData, int plevelOfRightData) {
        m_LeftData = pLeftData;
        m_levelOfLeftData = plevelOfLeftData;
        m_RightData = pRightData;
        m_levelOfRightData = plevelOfRightData;
    }
