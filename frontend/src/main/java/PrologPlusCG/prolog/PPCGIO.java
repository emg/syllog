 ...
 *
 */
public abstract class PPCGIO {
	protected PPCGEnv env = null;
	public PPCGIO(PPCGEnv myenv) { env = myenv; };
	abstract public void appendToConsole(String strToPrint);
	abstract public void setPrompt(String strToPrint);
	abstract public void clearConsole();
	abstract public String getNextQuery();
	abstract public void showMessageDialog(String strMessage, String strTitle);
	abstract public void showPrompt();
	public void showWaitCursor() {};
	public void showNormalCursor() {};
	abstract public void setProgramText(String strProgram); 
	abstract public void readSomething(byte readingMode);
}
