...
class UnificationRecord {
	Hashtable<String, VariableIndexPairList> record; 
	
	UnificationRecord() {
		record = new Hashtable<String, VariableIndexPairList>(10);
	}

	public VariableIndexPairList get(String key) {
		return record.get(key);
	}

	public void put(String key, VariableIndexPairList value) {
