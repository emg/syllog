...
var program = `
//
// Copyright (c) 2010-2018 Peter Oehrstroem and Ulrik Sandborg-Petersen
//
// License terms: MIT License.
// See COPYING.txt in the Syllog distribution.
//
...
// We only add the alternative, i-judgment, if: a) The original
// judgment was an a-judgment, and b) We have to write a graph.
writepropositionx(graph, pr(au, S, P)) :- 
     writeproposition(graph, pr(au, S, P)), 
     write("   "), 
     writeproposition(graph, pr(iu, S, P)), /.

// All other combinations exhibit no difference between
// writepropositionx and writeproposition.
...
function writeSyllogism() {
    bQueriedCorrectly = prolog.runQuery("write_syllogism_verbal.");
}
